...
-- Thời gian đã tạo: Th6 13, 2024 lúc 09:01 AM
...
(17, 3, 2, 'Đấu giá lô đất', ' Lô đất đặc biệt giá siêu rẻ', 100000000, '2024-06-12 09:00:00', '2024-06-12 09:00:00', '123 Main St, Anytown, USA', 37.7749, -122.419, 249, '2024-06-13 07:59:08');
...
(288, 249, 10.00000000, 100.00000000, 'login', '2024-06-13 09:00:27', '127.0.0.1');
...
(249, 'hieunguyen', 'admin2205', '$pbkdf2-sha256$29000$iXHunbOWEqJUSimltHZujQ$dzVuhYrthr3PiCsFDrucMVWbNOH1fsHHRrNpIis8U8U', 'hieunkbb@gmail.com', NULL, 'Nam', NULL, NULL, NULL, NULL, '127.0.0.1', '127.0.0.1', '2024-06-13 09:00:27', 1, 1, NULL, NULL, NULL, NULL, 1, 0, NULL);
...
--
ALTER TABLE `AuctionImgs`
  MODIFY `AuctionImgID` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=33;

--
-- AUTO_INCREMENT cho bảng `AuctionVideos`
--
ALTER TABLE `AuctionVideos`
  MODIFY `AuctionVideoID` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=14;
...
--
ALTER TABLE `LandAuctions`
  MODIFY `LandAuctionID` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=18;
...
--
ALTER TABLE `RefreshTokens`
  MODIFY `RefreshTokenID` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=13;
