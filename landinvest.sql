...
--
-- Host: localhost:3306
-- Generation Time: Jun 26, 2024 at 09:47 AM
...
(2, 126, 'di eeo to', '2024-06-09 05:33:45', 'phong nhanh vuotf au', 'https://gcs.tripi.vn/public-tripi/tripi-feed/img/474087SOH/avatar-cap-doi-dep-nhat_040408956.jpg'),
...
(53, 8, 8, 'Title for Post 8', 'This is the real content for post 8. It evaluates current trends and future prospects.', '2023-06-21 15:00:00', '192.168.1.8', 39.90420200, 116.40739400, '2023-06-21 15:00:00'),
(54, 1, 9, 'Title for Post 9', 'This is the real content for post 9. It analyzes data and statistics.', '2023-06-21 16:00:00', '192.168.1.9', 52.52000800, 13.40495400, '2023-06-21 16:00:00'),
(55, 1, 10, 'Title for Post 10', 'This is the real content for post 10. It discusses challenges and opportunities.', '2023-06-21 17:00:00', '192.168.1.10', 41.90278200, 12.49636600, '2023-06-21 17:00:00');
...
(2, 2, 1, 'Tim nguoi yeu ha noi', '2024-02-28 16:00:11', 'https://gcs.tripi.vn/public-tripi/tripi-feed/img/474087SOH/avatar-cap-doi-dep-nhat_040408956.jpg'),
(4, 2, 8, 'My Family', '2024-02-29 14:33:01', 'https://i.ibb.co/SVt2FxF/family.png'),
...
(8, 2, 8, 'sdfsd', '2024-02-29 14:41:36', 'https://i.ibb.co/RgL95VC/1-Spash-Screen.png'),
(9, 2, 8, 'me', '2024-02-29 14:42:42', 'https://i.ibb.co/PM83Tv3/429120657-1090999722050229-5526531086846996657-n.png'),
(10, 2, 8, 'oke', '2024-03-01 15:01:51', 'https://i.ibb.co/qWYJCGV/family.png'),
(11, 2, 223, 'Coder', '2024-06-08 18:23:50', '34343434');
...
CREATE TABLE `LandAuctions` (
  ...
  `AuctionAddress` varchar(500) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL,
  ...
  `NamePropertyOwner` varchar(500) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL,
  `NameProperty` varchar(500) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL,
  `AddressProperty` varchar(500) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL,
  `AddressPropertyOwner` varchar(500) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL,
  `AuctionUrl` varchar(1000) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL,
  `NameAuctionHouse` varchar(500) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL,
  `AddressAuctionHouse` varchar(500) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL,
...
(288, 249, 10.00000000, 100.00000000, 'login', '2024-06-26 02:18:12', '127.0.0.1');
...
(249, 'hieunguyen', 'admin2205', '$pbkdf2-sha256$29000$iXHunbOWEqJUSimltHZujQ$dzVuhYrthr3PiCsFDrucMVWbNOH1fsHHRrNpIis8U8U', 'hieunkbb@gmail.com', NULL, 'Nam', NULL, NULL, NULL, NULL, '127.0.0.1', '127.0.0.1', '2024-06-26 03:11:08', 0, 1, NULL, NULL, NULL, NULL, 1, 0, NULL);
...
--
ALTER TABLE `LandAuctions`
  MODIFY `LandAuctionID` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=25;
...
--
ALTER TABLE `RefreshTokens`
  MODIFY `RefreshTokenID` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=51;
